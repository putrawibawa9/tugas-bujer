...
<body>
    ...
    <div class="container">
        ...
        <form action="transaksi_edit_proses.php" method="post" enctype="multipart/form-data">
            <div class="mb-3 row">
                <label for="id_transaksi" class="col-sm-2 col-form-label">ID Transaksi</label>
                    <div class="col-sm-10">
                        <input type="text" value =" <?= $row['id_transaksi']?>" class="form-control" id="id_transaksi" name="id_transaksi" required>
                    </div>
                </div>
            <div class="mb-3 row">
                <label for="id_customer" class="col-sm-2 col-form-label">ID Customer</label>
                    <div class="col-sm-10">
                        <input type="id_customer" value =" <?= $row['id_customer']?>" class="form-control" id="id_customer" name="id_customer" required>
                    </div>
                </div>
            <div class="mb-3 row">
                <label for="id_komik" class="col-sm-2 col-form-label">ID Komik</label>
                    <div class="col-sm-10">
                        <input type="id_komik" value =" <?= $row['id_komik']?>" class="form-control" id="id_komik" name="id_komik" required>
                    </div>
                </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                <label for="jumlah_item" class="col-sm-2 col-form-label">Jumlah Item</label>
                    <div class="col-sm-10">
                        <input type="jumlah_item" value =" <?= $row['jumlah_item']?>" class="form-control" id="jumlah_item" name="jumlah" required>
                    </div>
                </div>
            <div class="mb-3 row">
                <label for="total_harga" class="col-sm-2 col-form-label">Total Harga</label>
                    <div class="col-sm-10">
                        <input type="total_harga" value =" <?= $row['total_harga']?>" class="form-control" id="total_harga" name="total_harga" required>
                    </div>
                </div>
            </div>
            <div class="mb-3 row">
