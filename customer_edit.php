...
<body>
    ...
    <div class="container">
        ...
        <form action="customer_edit_proses.php" method="post" enctype="multipart/form-data">
            <div class="mb-3 row">
                <label for="id_customer" class="col-sm-2 col-form-label">ID Customer</label>
                    <div class="col-sm-10">
                        <input type="id_customer" class="form-control"  id="id_customer" value =" <?= $row['id_customer']?>" name="id_customer" required>
                    </div>
                </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                <label for="no_hp" class="col-sm-2 col-form-label">No Handphone</label>
                    <div class="col-sm-10">
                        <input type="no_hp" class="form-control"  id="no_hp" value =" <?= $row['no_hp']?>" name="no_hp" required>
                    </div>
                </div>
            <div class="mb-3 row">
